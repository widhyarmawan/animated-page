                    ...
                    <div className={classes.SocMed}>
                        ...
                        <div className={[classes.Item, classes.Fb].join(' ')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="27" viewBox="0 0 13 27">
                                <path fill="#FFF" fill-rule="evenodd" d="M11.85 13.635H8.307v12.981H2.938V13.635H.385V9.073h2.553V6.12C2.938 4.01 3.941.704 8.354.704l3.977.016V5.15H9.446c-.474 0-1.14.236-1.14 1.243v2.685h4.013l-.47 4.558z"/>
                            </svg>
                        </div>
                        <div className={[classes.Item, classes.Li].join(' ')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="25" viewBox="0 0 26 25">
                                <path fill="#FFF" fill-rule="nonzero" d="M25.686 15.005v9.403h-5.365v-8.773c0-2.202-.775-3.707-2.718-3.707-1.482 0-2.363 1.013-2.752 1.994-.141.35-.178.837-.178 1.328v9.158H9.307s.072-14.859 0-16.397h5.367v2.324c-.011.018-.026.036-.036.054h.036v-.054c.713-1.115 1.984-2.709 4.836-2.709 3.53 0 6.176 2.344 6.176 7.38zM3.694.108C1.858.108.657 1.332.657 2.94c0 1.575 1.167 2.834 2.966 2.834h.035c1.872 0 3.035-1.26 3.035-2.834-.035-1.608-1.163-2.832-3-2.832zm-2.718 24.3H6.34V8.011H.976v16.397z"/>
                            </svg>
                        </div>
                    </div>
                </div>
