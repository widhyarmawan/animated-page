                        ...
                        <div className={classes.Icon}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="71" height="37" viewBox="0 0 71 37">
                                ...
                                <g fill="none" fillRule="evenodd" filter="url(#a)" transform="translate(4 2)">
                                    <rect width="60.32" height="27.04" x="1.04" y="1.04" fill="#1D0B46" stroke="#643B8E" strokeWidth="2.08" opacity=".503" rx="5.2"/>
                                    ...
                                    <text fill="#B5ABC7" fontFamily="Dosis-Medium, Dosis" fontSize="14.4" fontWeight="400" letterSpacing=".514">
